...
- 点击下载 USBIPD-WIN 5.2.0:<a href="https://aithinker-static.oss-cn-shenzhen.aliyuncs.com/docs/media/development/tools/usbipd-win_5.2.0_x64.msi" style="display: inline-block; padding: 2px 8px; background-color: #364475; color: white; text-decoration: none; border-radius: 6px; font-size: 14px;">点击下载</a> 
- 双击安装，根据提示完成安装
- 重启电脑
### 连接 USB 设备
#### 步骤1
