...
- icon: "/svg/ecode.svg"
  title: "第一步"
  text: 在 “tuyaos_demo_quickstart” demo 中复制“dp_process.c” 和 “dp_process.h” 文件到我们的项目中。
  image: "/img/tuya/appled/step3_1.png"
  alt: "无效图片"
- icon: "/svg/ecode.svg"
  title: "第二步"
  text: 修改 "dp_process.c" 中的 `app_led.h` 为 `net_led.h`
  image: "/img/tuya/appled/step3_2.png"
  alt: "无效图片"
- icon: "/svg/ok.svg"
  title: "第三步"
  text: 编译测试，确保没有错误。
...
- icon: "/svg/ecode.svg"
  title: "第一步"
  text: 修改闪灯逻辑，避免 LED 的控制效果与配网状态显示冲突。
  image: "/img/tuya/appled/step5_1.png"
  alt: "无效图片"
- icon: "/svg/ecode.svg"
  title: "第二步"
  text: 在 `dp_obj_process` 函数中修改 LED 状态的设置逻辑。<br> 在 “dp_process.c” 定位到 `94` 行.如右图中修改。
  image: "/img/tuya/appled/step5_2.png"
  alt: "无效图片"
- icon: "/svg/ecode.svg"
  title: "第三步"
  text: 在 “tuya_device.c” 中引用 “dp_process.h” 头文件。
  alt: "无效图片"
- icon: "/svg/ecode.svg"
  title: "第四步"
  text: 在 “tuya_device.c” 的 `__soc_dev_obj_dp_cmd_cb` 函数中调用 `dp_obj_process` 函数。<br> 如右图所示
  image: "/img/tuya/appled/step5_3.png"
  alt: "无效图片"
- icon: "/svg/ecode.svg"
  title: "第五步"
  text: 编译并烧录程序到开发板。
...
- icon: "/svg/ok.svg"
  title: "第六步"
  text: 测试 LED 控制功能。<br> 打开 App，连接到开发板的 Wi-Fi 网络。<br> 在 App 中找到我们的设备，点击开关按钮，观察 LED 的亮灭。
```
