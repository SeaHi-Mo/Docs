...
permalink: /hermes/developer-guide/provider-runtime
---
...
如果你尝试添加新的第一类推理提供商，请同时阅读[添加提供商](./adding-providers.md)。
...
2. **触发点**：`run_agent.py` 主重试循环中的三个位置调用 `_try_activate_fallback()`：
